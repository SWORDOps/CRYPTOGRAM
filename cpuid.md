CPU 0:
   ...
   processor serial number = 000A-06A4-0000-0000-0000-0000
   deterministic cache parameters (4):
      ...
      self-initializing cache level      = true
      fully associative cache            = false
      maximum IDs for CPUs sharing cache = 0x3f (63)
      maximum IDs for cores in pkg       = 0x3f (63)
      system coherency line size         = 0x40 (64)
      physical line partitions           = 0x1 (1)
      ways of associativity              = 0xc (12)
   ...
   MONITOR/MWAIT (5):
      ...
      number of C4 sub C-states using MWAIT    = 0x1 (1)
   ...
   extended feature flags (7):
      ...
      ArchPerfmonExt leaf 0x23 is valid        = true
      fast zero-length REP MOVSB               = false
      fast short REP STOSB                     = true
      ...
      INVD prevention after BIOS done          = true
      MOVRS instructions                       = false
      IA32_PPIN & IA32_PPIN_CTL MSRs supported = true
      ...
      CET_SSS: shadow stacks w/o page faults   = true
      ...
      IPRED_CTRL: IBP disable                  = true
      RRSBA_CTRL: IBP bottomless RSB disable   = true
      DDPD_U: data dep prefetcher disable      = true
      BHI_CTRL: IBP BHB-focused disable        = true
      MCDT_NO: MCDT mitigation not needed      = true
      UC-lock disable                          = false
      MONITOR perf unaffected by tbl overflow  = true
   ...
   x2APIC features / processor topology (0xb):
      ...
      number of logical processors at level = 0x16 (22)
      --- level 2 ---
      level number                          = 0x2 (2)
   ...
   XSAVE features (0xd/0):
      ...
      SAVE area size in bytes                 = 0x00000698 (1688)
      IA32_XSS valid bit field mask           = 0x0000000000019900
         PT state                             = true
         PASID state                          = false
   ...
   Software Guard Extensions (SGX) capability (0x12/0):
      ...
      256BITSGX EGETKEY256 & EREPORT2          = false
   ...
   Intel Processor Trace (0x14):
      ...
      number of IA32_RTIT_TRIGGERx_CFG MSRs  = 0x0 (0)
      ...
      trigger action attribution supported   = false
      TRACE_PAUSE, TRACE_RESUME supported    = false
      trigger input DR match supported       = false
   Time Stamp Counter/Core Crystal Clock Information (0x15):
      TSC/clock ratio = 160/2
      nominal core crystal clock = 38400000 Hz
   Processor Frequency Information (0x16):
      Core Base Frequency (MHz) = 0xc1c (3100)
      Core Maximum Frequency (MHz) = 0x1388 (5000)
      Bus (Reference) Frequency (MHz) = 0x64 (100)
   System-On-Chip Vendor Attribute (0x17):
      vendor id     = 0x0 (0)
   ...
   Deterministic Address Translation Parameters (0x18/1):
      ...
      fully associative                 = false
      maximum number of addressible IDs = 0x2 (2)
   ...
   Native Model ID Information (0x1a/0):
      native model ID of core = 0x2 (2)
      core type               = Intel Core
   PCONFIG information (0x1b/0x0):
      sub-leaf type = target identifier (1)
      identifier of target 1 = MKTME (1)
      identifier of target 2 = ignored (0)
      identifier of target 3 = ignored (0)
   ...
   Architectural LBR Capabilities (0x1c/0):
      ...
      event logging supported bitmap    = 0x0 (0)
   Tile Information (0x1d):
      max_palette = 0
   TMUL Information (0x1e):
      tmul_maxk                                = 0x0 (0)
      tmul_maxn                                = 0x0 (0)
   ...
   Architecture Performance Monitoring Extended (0x23/0):
      architectural PEBS support           = false
      IA32_PERFEVTSELx UnitMask2 supported = false
      IA32_PERFEVTSELx EQ bit supported    = false
      number of slots per cycle            = 0x0 (0)
   Architecture Performance Monitoring Extended Counters Supported Bitmaps (0x23/1):
      general counters bitmap = 0xff
      fixed counters bitmap   = 0xf
   Architecture Performance Monitoring Extended Supported Events (0x23/3):
      core cycles                 = true
      instructions retired        = true
      reference cycles            = true
      last level cache references = true
      last level cache misses     = true
      branch instructions retired = true
      branch mispredicts retired  = true
      topdown slots               = true
      topdown backend bound       = true
      topdown bad speculation     = false
      topdown frontend bound      = true
      topdown retiring            = true
      LBR inserts                 = false
   ...
   brand = "Intel(R) Core(TM) Ultra 7 165H"
   ...
   (instruction supported synth):
      MWAIT = true
   (multi-processing synth) = multi-module (m=11), hyper-threaded (t=2)
   (multi-processing method) = Intel leaf 0x1f
   (APIC widths synth): MOD_width=4 CORE_width=2 SMT_width=1
   (APIC synth): PKG_ID=0 MOD_ID=4 CORE_ID=0 SMT_ID=0
   (uarch synth) = Intel Redwood Cove {shrink of Raptor Cove, optim of Golden Cove}, Intel 4
   (synth) = Intel (Core Ultra 1xxH) (Meteor Lake-M C0) [Redwood Cove] {shrink of Raptor Cove, optim of Golden Cove}, Intel 4
CPU 1:
   vendor_id = "GenuineIntel"
   version information (1/eax):
      processor type  = primary processor (0)
   ...
   (multi-processing method) = Intel leaf 0x1f
   (APIC widths synth): MOD_width=4 CORE_width=2 SMT_width=1
   (APIC synth): PKG_ID=0 MOD_ID=2 CORE_ID=0 SMT_ID=0
   (uarch synth) = Intel Redwood Cove {shrink of Raptor Cove, optim of Golden Cove}, Intel 4
   (synth) = Intel (Core Ultra 1xxH) (Meteor Lake-M C0) [Redwood Cove] {shrink of Raptor Cove, optim of Golden Cove}, Intel 4
CPU 2:
   vendor_id = "GenuineIntel"
   ...
   (multi-processing method) = Intel leaf 0x1f
   (APIC widths synth): MOD_width=4 CORE_width=2 SMT_width=1
   (APIC synth): PKG_ID=0 MOD_ID=2 CORE_ID=0 SMT_ID=1
   (uarch synth) = Intel Redwood Cove {shrink of Raptor Cove, optim of Golden Cove}, Intel 4
   (synth) = Intel (Core Ultra 1xxH) (Meteor Lake-M C0) [Redwood Cove] {shrink of Raptor Cove, optim of Golden Cove}, Intel 4
CPU 3:
   vendor_id = "GenuineIntel"
   ...
   (multi-processing method) = Intel leaf 0x1f
   (APIC widths synth): MOD_width=4 CORE_width=2 SMT_width=1
   (APIC synth): PKG_ID=0 MOD_ID=3 CORE_ID=0 SMT_ID=0
   (uarch synth) = Intel Redwood Cove {shrink of Raptor Cove, optim of Golden Cove}, Intel 4
   (synth) = Intel (Core Ultra 1xxH) (Meteor Lake-M C0) [Redwood Cove] {shrink of Raptor Cove, optim of Golden Cove}, Intel 4
CPU 4:
   vendor_id = "GenuineIntel"
   ...
   (multi-processing method) = Intel leaf 0x1f
   (APIC widths synth): MOD_width=4 CORE_width=2 SMT_width=1
   (APIC synth): PKG_ID=0 MOD_ID=3 CORE_ID=0 SMT_ID=1
   (uarch synth) = Intel Redwood Cove {shrink of Raptor Cove, optim of Golden Cove}, Intel 4
   (synth) = Intel (Core Ultra 1xxH) (Meteor Lake-M C0) [Redwood Cove] {shrink of Raptor Cove, optim of Golden Cove}, Intel 4
CPU 5:
   vendor_id = "GenuineIntel"
   ...
   (multi-processing method) = Intel leaf 0x1f
   (APIC widths synth): MOD_width=4 CORE_width=2 SMT_width=1
   (APIC synth): PKG_ID=0 MOD_ID=4 CORE_ID=0 SMT_ID=1
   (uarch synth) = Intel Redwood Cove {shrink of Raptor Cove, optim of Golden Cove}, Intel 4
   (synth) = Intel (Core Ultra 1xxH) (Meteor Lake-M C0) [Redwood Cove] {shrink of Raptor Cove, optim of Golden Cove}, Intel 4
CPU 6:
   vendor_id = "GenuineIntel"
   ...
   (multi-processing method) = Intel leaf 0x1f
   (APIC widths synth): MOD_width=4 CORE_width=2 SMT_width=1
   (APIC synth): PKG_ID=0 MOD_ID=5 CORE_ID=0 SMT_ID=0
   (uarch synth) = Intel Redwood Cove {shrink of Raptor Cove, optim of Golden Cove}, Intel 4
   (synth) = Intel (Core Ultra 1xxH) (Meteor Lake-M C0) [Redwood Cove] {shrink of Raptor Cove, optim of Golden Cove}, Intel 4
CPU 7:
   vendor_id = "GenuineIntel"
   ...
   (multi-processing method) = Intel leaf 0x1f
   (APIC widths synth): MOD_width=4 CORE_width=2 SMT_width=1
   (APIC synth): PKG_ID=0 MOD_ID=5 CORE_ID=0 SMT_ID=1
   (uarch synth) = Intel Redwood Cove {shrink of Raptor Cove, optim of Golden Cove}, Intel 4
   (synth) = Intel (Core Ultra 1xxH) (Meteor Lake-M C0) [Redwood Cove] {shrink of Raptor Cove, optim of Golden Cove}, Intel 4
CPU 8:
   vendor_id = "GenuineIntel"
   ...
   Thermal and Power Management Features (6):
      ...
      energy efficiency capability reporting  = true
      size of feedback struct (4KB pages)     = 0x1 (1)
      index of CPU's row in feedback struct   = 0x8 (8)
   extended feature flags (7):
      FSGSBASE instructions                    = true
      IA32_TSC_ADJUST MSR supported            = true
      SGX: Software Guard Extensions supported = false
   ...
   (multi-processing method) = Intel leaf 0x1f
   (APIC widths synth): MOD_width=4 CORE_width=2 SMT_width=1
   (APIC synth): PKG_ID=0 MOD_ID=6 CORE_ID=0 SMT_ID=0
   (uarch synth) = Intel Redwood Cove {shrink of Raptor Cove, optim of Golden Cove}, Intel 4
   (synth) = Intel (Core Ultra 1xxH) (Meteor Lake-M C0) [Redwood Cove] {shrink of Raptor Cove, optim of Golden Cove}, Intel 4
CPU 9:
   vendor_id = "GenuineIntel"
   ...
   Thermal and Power Management Features (6):
      ...
      energy efficiency capability reporting  = true
      size of feedback struct (4KB pages)     = 0x1 (1)
      index of CPU's row in feedback struct   = 0x9 (9)
   extended feature flags (7):
      FSGSBASE instructions                    = true
      IA32_TSC_ADJUST MSR supported            = true
      SGX: Software Guard Extensions supported = false
   ...
   (multi-processing method) = Intel leaf 0x1f
   (APIC widths synth): MOD_width=4 CORE_width=2 SMT_width=1
   (APIC synth): PKG_ID=0 MOD_ID=6 CORE_ID=0 SMT_ID=1
   (uarch synth) = Intel Redwood Cove {shrink of Raptor Cove, optim of Golden Cove}, Intel 4
   (synth) = Intel (Core Ultra 1xxH) (Meteor Lake-M C0) [Redwood Cove] {shrink of Raptor Cove, optim of Golden Cove}, Intel 4
CPU 10:
   vendor_id = "GenuineIntel"
   ...
   Thermal and Power Management Features (6):
      ...
      energy efficiency capability reporting  = true
      size of feedback struct (4KB pages)     = 0x1 (1)
      index of CPU's row in feedback struct   = 0xa (10)
   extended feature flags (7):
      FSGSBASE instructions                    = true
      IA32_TSC_ADJUST MSR supported            = true
      SGX: Software Guard Extensions supported = false
   ...
   Architecture Performance Monitoring Extended (0x23/0):
      ...
      IA32_PERFEVTSELx UnitMask2 supported = false
      IA32_PERFEVTSELx EQ bit supported    = false
      number of slots per cycle            = 0x6 (6)
   Architecture Performance Monitoring Extended Counters Supported Bitmaps (0x23/1):
      general counters bitmap = 0xff
      fixed counters bitmap   = 0x7
   Architecture Performance Monitoring Extended Supported Events (0x23/3):
      core cycles                 = true
      instructions retired        = true
      reference cycles            = true
      ...
      branch mispredicts retired  = true
      topdown slots               = false
      topdown backend bound       = false
      topdown bad speculation     = false
      topdown frontend bound      = false
      topdown retiring            = false
      LBR inserts                 = false
   extended feature flags (0x80000001/edx):
      SYSCALL and SYSRET instructions        = true
      execution disable                      = true
   ...
   (instruction supported synth):
      MWAIT = true
   (multi-processing synth) = multi-module (m=5), multi-core (c=4)
   (multi-processing method) = Intel leaf 0x1f
   (APIC widths synth): MOD_width=4 CORE_width=2 SMT_width=1
   (APIC synth): PKG_ID=0 MOD_ID=0 CORE_ID=0 SMT_ID=0
   (uarch synth) = Intel Crestmont, Intel 4
   (synth) = Intel (Core Ultra 1xxH) (Meteor Lake-M C0) [Crestmont], Intel 4
CPU 11:
   vendor_id = "GenuineIntel"
   version information (1/eax):
      processor type  = primary processor (0)
   ...
   Thermal and Power Management Features (6):
      ...
      energy efficiency capability reporting  = true
      size of feedback struct (4KB pages)     = 0x1 (1)
      index of CPU's row in feedback struct   = 0xb (11)
   extended feature flags (7):
      FSGSBASE instructions                    = true
      IA32_TSC_ADJUST MSR supported            = true
      SGX: Software Guard Extensions supported = false
   ...
   (multi-processing method) = Intel leaf 0x1f
   (APIC widths synth): MOD_width=4 CORE_width=2 SMT_width=1
   (APIC synth): PKG_ID=0 MOD_ID=0 CORE_ID=1 SMT_ID=0
   (uarch synth) = Intel Crestmont, Intel 4
   (synth) = Intel (Core Ultra 1xxH) (Meteor Lake-M C0) [Crestmont], Intel 4
CPU 12:
   vendor_id = "GenuineIntel"
   ...
   Thermal and Power Management Features (6):
      ...
      energy efficiency capability reporting  = true
      size of feedback struct (4KB pages)     = 0x1 (1)
      index of CPU's row in feedback struct   = 0xc (12)
   extended feature flags (7):
      FSGSBASE instructions                    = true
      IA32_TSC_ADJUST MSR supported            = true
      SGX: Software Guard Extensions supported = false
   ...
   (multi-processing method) = Intel leaf 0x1f
   (APIC widths synth): MOD_width=4 CORE_width=2 SMT_width=1
   (APIC synth): PKG_ID=0 MOD_ID=0 CORE_ID=2 SMT_ID=0
   (uarch synth) = Intel Crestmont, Intel 4
   (synth) = Intel (Core Ultra 1xxH) (Meteor Lake-M C0) [Crestmont], Intel 4
CPU 13:
   vendor_id = "GenuineIntel"
   ...
   Thermal and Power Management Features (6):
      ...
      energy efficiency capability reporting  = true
      size of feedback struct (4KB pages)     = 0x1 (1)
      index of CPU's row in feedback struct   = 0xd (13)
   extended feature flags (7):
      FSGSBASE instructions                    = true
      IA32_TSC_ADJUST MSR supported            = true
      SGX: Software Guard Extensions supported = false
   ...
   (multi-processing method) = Intel leaf 0x1f
   (APIC widths synth): MOD_width=4 CORE_width=2 SMT_width=1
   (APIC synth): PKG_ID=0 MOD_ID=0 CORE_ID=3 SMT_ID=0
   (uarch synth) = Intel Crestmont, Intel 4
   (synth) = Intel (Core Ultra 1xxH) (Meteor Lake-M C0) [Crestmont], Intel 4
CPU 14:
   vendor_id = "GenuineIntel"
   ...
   Thermal and Power Management Features (6):
      ...
      energy efficiency capability reporting  = true
      size of feedback struct (4KB pages)     = 0x1 (1)
      index of CPU's row in feedback struct   = 0xe (14)
   extended feature flags (7):
      FSGSBASE instructions                    = true
      IA32_TSC_ADJUST MSR supported            = true
      SGX: Software Guard Extensions supported = false
   ...
   (multi-processing method) = Intel leaf 0x1f
   (APIC widths synth): MOD_width=4 CORE_width=2 SMT_width=1
   (APIC synth): PKG_ID=0 MOD_ID=1 CORE_ID=0 SMT_ID=0
   (uarch synth) = Intel Crestmont, Intel 4
   (synth) = Intel (Core Ultra 1xxH) (Meteor Lake-M C0) [Crestmont], Intel 4
CPU 15:
   vendor_id = "GenuineIntel"
   ...
   Thermal and Power Management Features (6):
      ...
      energy efficiency capability reporting  = true
      size of feedback struct (4KB pages)     = 0x1 (1)
      index of CPU's row in feedback struct   = 0xf (15)
   extended feature flags (7):
      FSGSBASE instructions                    = true
      IA32_TSC_ADJUST MSR supported            = true
      SGX: Software Guard Extensions supported = false
   ...
   (multi-processing method) = Intel leaf 0x1f
   (APIC widths synth): MOD_width=4 CORE_width=2 SMT_width=1
   (APIC synth): PKG_ID=0 MOD_ID=1 CORE_ID=1 SMT_ID=0
   (uarch synth) = Intel Crestmont, Intel 4
   (synth) = Intel (Core Ultra 1xxH) (Meteor Lake-M C0) [Crestmont], Intel 4
CPU 16:
   vendor_id = "GenuineIntel"
   ...
   Thermal and Power Management Features (6):
      ...
      energy efficiency capability reporting  = true
      size of feedback struct (4KB pages)     = 0x1 (1)
      index of CPU's row in feedback struct   = 0x10 (16)
   extended feature flags (7):
      FSGSBASE instructions                    = true
      IA32_TSC_ADJUST MSR supported            = true
      SGX: Software Guard Extensions supported = false
   ...
   (multi-processing method) = Intel leaf 0x1f
   (APIC widths synth): MOD_width=4 CORE_width=2 SMT_width=1
   (APIC synth): PKG_ID=0 MOD_ID=1 CORE_ID=2 SMT_ID=0
   (uarch synth) = Intel Crestmont, Intel 4
   (synth) = Intel (Core Ultra 1xxH) (Meteor Lake-M C0) [Crestmont], Intel 4
CPU 17:
   vendor_id = "GenuineIntel"
   version information (1/eax):
      ...
      (model synth)   = 0xaa (170)
   miscellaneous (1/ebx):
      process local APIC physical ID = 0xe (14)
      maximum IDs for CPUs in pkg    = 0x80 (128)
      CLFLUSH line size              = 0x8 (8)
      brand index                    = 0x0 (0)
   brand id = 0x00 (0): unknown
   ...
   Thermal and Power Management Features (6):
      ...
      energy efficiency capability reporting  = true
      size of feedback struct (4KB pages)     = 0x1 (1)
      index of CPU's row in feedback struct   = 0x11 (17)
   extended feature flags (7):
      FSGSBASE instructions                    = true
      IA32_TSC_ADJUST MSR supported            = true
      SGX: Software Guard Extensions supported = false
   ...
   (multi-processing method) = Intel leaf 0x1f
   (APIC widths synth): MOD_width=4 CORE_width=2 SMT_width=1
   (APIC synth): PKG_ID=0 MOD_ID=1 CORE_ID=3 SMT_ID=0
   (uarch synth) = Intel Crestmont, Intel 4
   (synth) = Intel (Core Ultra 1xxH) (Meteor Lake-M C0) [Crestmont], Intel 4
CPU 18:
   vendor_id = "GenuineIntel"
   version information (1/eax):
      ...
      (model synth)   = 0xaa (170)
   miscellaneous (1/ebx):
      process local APIC physical ID = 0x40 (64)
      maximum IDs for CPUs in pkg    = 0x80 (128)
      CLFLUSH line size              = 0x8 (8)
      brand index                    = 0x0 (0)
   brand id = 0x00 (0): unknown
   ...
   Thermal and Power Management Features (6):
      ...
      energy efficiency capability reporting  = true
      size of feedback struct (4KB pages)     = 0x1 (1)
      index of CPU's row in feedback struct   = 0x12 (18)
   extended feature flags (7):
      FSGSBASE instructions                    = true
      IA32_TSC_ADJUST MSR supported            = true
      SGX: Software Guard Extensions supported = false
   ...
   (instruction supported synth):
      MWAIT = true
   (multi-processing synth) = multi-module (m=11), multi-core (c=2)
   (multi-processing method) = Intel leaf 0x1f
   (APIC widths synth): MOD_width=4 CORE_width=2 SMT_width=1
   (APIC synth): PKG_ID=0 MOD_ID=8 CORE_ID=0 SMT_ID=0
   (uarch synth) = Intel Crestmont, Intel 4
   (synth) = Intel (Core Ultra 1xxH) (Meteor Lake-M C0) [Crestmont], Intel 4
CPU 19:
   vendor_id = "GenuineIntel"
   version information (1/eax):
      ...
      (model synth)   = 0xaa (170)
   miscellaneous (1/ebx):
      process local APIC physical ID = 0x42 (66)
      maximum IDs for CPUs in pkg    = 0x80 (128)
      CLFLUSH line size              = 0x8 (8)
      brand index                    = 0x0 (0)
   brand id = 0x00 (0): unknown
   ...
   Thermal and Power Management Features (6):
      ...
      energy efficiency capability reporting  = true
      size of feedback struct (4KB pages)     = 0x1 (1)
      index of CPU's row in feedback struct   = 0x13 (19)
   extended feature flags (7):
      FSGSBASE instructions                    = true
      IA32_TSC_ADJUST MSR supported            = true
      SGX: Software Guard Extensions supported = false
   ...
   (multi-processing method) = Intel leaf 0x1f
   (APIC widths synth): MOD_width=4 CORE_width=2 SMT_width=1
   (APIC synth): PKG_ID=0 MOD_ID=8 CORE_ID=1 SMT_ID=0
   (uarch synth) = Intel Crestmont, Intel 4
   (synth) = Intel (Core Ultra 1xxH) (Meteor Lake-M C0) [Crestmont], Intel 4
