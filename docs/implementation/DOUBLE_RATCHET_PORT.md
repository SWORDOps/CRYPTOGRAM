...
## Overview
This document describes the Double Ratchet design intent (requires validation) encryption implementation that has been ported from SpyGram to CRYPTOGRAM.
