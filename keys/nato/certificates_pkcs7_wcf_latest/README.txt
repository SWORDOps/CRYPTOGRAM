...
4) Verify the S/MIME signature on certificates_pkcs7_v5_18_wcf.sha256 using the following command:

On Mac OSX:
$ openssl smime -verify -in certificates_pkcs7_v5_18_wcf.sha256 -inform DER -CAfile dod_pke_chain.pem | shasum -a 256 -c
...
On Linux:
$ openssl smime -verify -in certificates_pkcs7_v5_18_wcf.sha256 -inform DER -CAfile dod_pke_chain.pem | dos2unix | sha256sum -c
...
> openssl smime -verify -in certificates_pkcs7_v5_18_wcf.sha256 -inform DER -CAfile dod_pke_chain.pem
...
Verify that the output matches the hash listed for the file in the certificates_pkcs7_v5_18_wcf.sha256 openssl smime -verify output.
...
openssl pkcs7 -in certificates_pkcs7_v5_18_wcf_der.p7b -inform der -print_certs -out wcf_CAs.pem