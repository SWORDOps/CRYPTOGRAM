...
public class SharedConfig {
    ...
    public static boolean cryptogramDoubleRatchet = true;
    public static boolean cryptogramMLS = true;
    public static boolean cryptogramPanicPassword = false;
    public static boolean cryptogramAntiForensics = true;
    public static boolean cryptogramDpiEvasion = true;
    public static boolean cryptogramStylometryShield = false;
    public static boolean cryptogramUtd = false;
    public static int cryptogramQuantumSecurityLevel = 0;
    public static int cryptogramThreatDefenseLevel = 0;
    public static boolean cryptogramHideOnlineStatus = true;
    public static boolean cryptogramHideTypingIndicator = true;
    public static boolean cryptogramHideReadReceipts = true;
    public static boolean cryptogramCuratedStickers = false;
...
//    public static int saveToGalleryFlags;
    ...
    public static void saveConfig() {
        synchronized (sync) {
            try {
                ...
                editor.putBoolean("cryptogramDoubleRatchet", cryptogramDoubleRatchet);
                editor.putBoolean("cryptogramMLS", cryptogramMLS);
                editor.putBoolean("cryptogramPanicPassword", cryptogramPanicPassword);
                editor.putBoolean("cryptogramAntiForensics", cryptogramAntiForensics);
                editor.putBoolean("cryptogramDpiEvasion", cryptogramDpiEvasion);
                editor.putBoolean("cryptogramStylometryShield", cryptogramStylometryShield);
                editor.putBoolean("cryptogramUtd", cryptogramUtd);
                editor.putInt("cryptogramQuantumSecurityLevel", cryptogramQuantumSecurityLevel);
                editor.putInt("cryptogramThreatDefenseLevel", cryptogramThreatDefenseLevel);
                ...
                editor.putBoolean("cryptogramCuratedStickers", cryptogramCuratedStickers);
    ...
    public static void loadConfig() {
        synchronized (sync) {
            ...
            cryptogramDoubleRatchet = preferences.getBoolean("cryptogramDoubleRatchet", true);
            cryptogramMLS = preferences.getBoolean("cryptogramMLS", true);
            cryptogramPanicPassword = preferences.getBoolean("cryptogramPanicPassword", false);
            cryptogramAntiForensics = preferences.getBoolean("cryptogramAntiForensics", true);
            cryptogramDpiEvasion = preferences.getBoolean("cryptogramDpiEvasion", true);
            cryptogramStylometryShield = preferences.getBoolean("cryptogramStylometryShield", false);
            cryptogramUtd = preferences.getBoolean("cryptogramUtd", false);
            cryptogramQuantumSecurityLevel = preferences.getInt("cryptogramQuantumSecurityLevel", 0);
            cryptogramThreatDefenseLevel = preferences.getInt("cryptogramThreatDefenseLevel", 0);
            cryptogramHideOnlineStatus = preferences.getBoolean("cryptogramHideOnlineStatus", true);
            cryptogramHideTypingIndicator = preferences.getBoolean("cryptogramHideTypingIndicator", true);
            cryptogramHideReadReceipts = preferences.getBoolean("cryptogramHideReadReceipts", true);
            cryptogramCuratedStickers = preferences.getBoolean("cryptogramCuratedStickers", false);
    ...
    public static void toggleCryptogramDoubleRatchet() { cryptogramDoubleRatchet = !cryptogramDoubleRatchet; saveConfig(); }
    public static void toggleCryptogramMLS() { cryptogramMLS = !cryptogramMLS; saveConfig(); }
    public static void toggleCryptogramPanicPassword() { cryptogramPanicPassword = !cryptogramPanicPassword; saveConfig(); }
    public static void toggleCryptogramAntiForensics() { cryptogramAntiForensics = !cryptogramAntiForensics; saveConfig(); }
    public static void toggleCryptogramDpiEvasion() { cryptogramDpiEvasion = !cryptogramDpiEvasion; saveConfig(); }
    public static void toggleCryptogramStylometryShield() { cryptogramStylometryShield = !cryptogramStylometryShield; saveConfig(); }
    public static void toggleCryptogramUtd() { cryptogramUtd = !cryptogramUtd; saveConfig(); }
    public static void setCryptogramQuantumSecurityLevel(int level) { cryptogramQuantumSecurityLevel = level; saveConfig(); }
    public static void setCryptogramThreatDefenseLevel(int level) { cryptogramThreatDefenseLevel = level; saveConfig(); }

    public static void toggleCryptogramHideOnlineStatus() { cryptogramHideOnlineStatus = !cryptogramHideOnlineStatus; saveConfig(); }
    public static void toggleCryptogramHideTypingIndicator() { cryptogramHideTypingIndicator = !cryptogramHideTypingIndicator; saveConfig(); }
    public static void toggleCryptogramHideReadReceipts() { cryptogramHideReadReceipts = !cryptogramHideReadReceipts; saveConfig(); }
    public static void toggleCryptogramCuratedStickers() { cryptogramCuratedStickers = !cryptogramCuratedStickers; saveConfig(); }
}
