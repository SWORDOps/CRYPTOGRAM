...
object_ptr<Ui::GenericBox> ChoosePlaybackDeviceBox(
	...
	return Box(
		...
		rpl::producer<QString>(tr::lng_settings_call_output_device()),
...
object_ptr<Ui::GenericBox> ChooseCaptureDeviceBox(
	...
	return Box(
		ChooseMediaDeviceBox,
		rpl::producer<QString>(tr::lng_settings_call_input_device()),
...
object_ptr<Ui::GenericBox> ChooseCameraDeviceBox(
	...
	return Box(
		ChooseMediaDeviceBox,
		rpl::producer<QString>(tr::lng_settings_call_camera()),
